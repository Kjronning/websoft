(function () {
    ...
    divSizeSpan.innerHTML = '<br>offsetWidth: ' +
    divSize.osWidth + 'px, offsetHeight: ' +
    divSize.osHeight + 'px<br>clientWidth: ' +
    divSize.clWidth + 'px, clientHeight: ' +
    divSize.clHeight + 'px<br>Pos left: ' +
    divSize.posLeft + 'px, Pos Top: ' +
    divSize.posTop + 'px';
    ...
    spanOne.innerHTML = '(border: 0, margin: 0, padding: 0)<br>offsetWidth: ' +
    divSize.osWidth + 'px, offsetHeight: ' +
    divSize.osHeight + 'px<br>clientWidth: ' + divSize.clWidth + 'px, clientHeight: ' +
    divSize.clHeight + 'px<br>Pos left: ' +
    divSize.posLeft + 'px, Pos Top: ' + divSize.posTop + 'px';
    ...
    spanTwo.innerHTML = '(border: 0, margin: 10, padding: 0)<br>offsetWidth: ' +
    divSize.osWidth + 'px, offsetHeight: ' + divSize.osHeight + 'px<br>clientWidth: ' +
    divSize.clWidth + 'px, clientHeight: ' + divSize.clHeight + 'px<br>Pos left: ' +
    divSize.posLeft + 'px, Pos Top: ' + divSize.posTop + 'px';
    ...
    spanThree.innerHTML = '(border: 0, margin: 10, padding: 10)<br>offsetWidth: ' +
    divSize.osWidth + ' X ' + divSize.osHeight + 'px<br>clientWidth: ' +
    divSize.clWidth + ' X ' + divSize.clHeight + 'px<br>Pos left: ' +
    divSize.posLeft + 'px, Pos Top: ' + divSize.posTop + 'px';
    ...
    spanFour.innerHTML = '(border: 10, margin: 10, padding: 10)<br>offsetWidth: ' +
    divSize.osWidth + ' X ' + divSize.osHeight + 'px<br>clientWidth: ' +
    divSize.clWidth + ' X ' + divSize.clHeight + 'px<br>Pos left: ' +
    divSize.posLeft + 'px, Pos Top: ' + divSize.posTop + 'px';
