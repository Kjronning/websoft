...
function initWebGL() {
    ...
    // Enable hindden surface removal
...
function main() {
    ...
    mvp.setView(3.06, 2.5, 10.0, 0, 0, -2, 0, 1, 0);
    mvp.projection.setPerspective(30, gl.canvas.width/gl.canvas.height, 1, 100);
    ...
    function render() {
        ...
        gl.drawArrays(data.mode, 0, data.n/2);
        gl.polygonOffset(1.0, 1.0);
        gl.drawArrays(data.mode, data.n/2, data.n/2);
    }
